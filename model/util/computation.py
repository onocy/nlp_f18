...
def build_genre_input_data(artist_dict, vocab_index, genre_indices):
    """
    ...
    Args:
        artist_dict: (dict[str, dict[str, dict[str, torch.tensor]]]): A dictionary mapping music genres to dictionaries
    ...
    input_set = []
    for genre in artist_dict:
        for artist in artist_dict[genre]:
            for song in artist_dict[genre][artist]:
                lyric_indices = lyrics_to_vocab_idx(artist_dict[genre][artist][song], vocab_index)
